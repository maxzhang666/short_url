    ...
    function blum_backgrounds() {
        ...
        if ($body.hasClass('slideshow-background')) {
            $body.vegas({
                ...
                slides: [
                    { src: './static/blum/demo/images/image-15.jpg' },
                    { src: './static/blum/demo/images/image-16.jpg' },
                    { src: './static/blum/demo/images/image-17.jpg' },
                    { src: './static/blum/demo/images/image-4.jpg' }
                ]
            });
        }
        ...
        if ($body.hasClass('kenburns-background')) {
            ...
            var kenburnsBackgrounds = [
                { src: './static/blum/demo/images/image-15.jpg', valign: 'top' },
                { src: './static/blum/demo/images/image-14.jpg', valign: 'top' },
                { src: './static/blum/demo/images/image-17.jpg', valign: 'top' }
            ];
