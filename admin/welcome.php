				...
				<div class="panel panel-default contact-panel">
					...
					<div class="panel-body">
						...
						if ($conf['version'] >= $str['version']) {
							...
							echo '<span style="color:red;">发现新版本' . $str['edition'] . ',请手动下载更新 <a href="' . $str['update'] . '" class="btn btn-success" target="_blank">更新包</a> <a href="' . $str['release'] . '" class="btn btn-warning" target="_blank">完整包</a></span>';
						}
						?>
					</div>
				</div>
