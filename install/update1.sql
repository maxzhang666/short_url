ALTER TABLE `user_list` ADD COLUMN `lasttime` datetime DEFAULT CURRENT_TIMESTAMP;

INSERT INTO `config`(`k`, `v`) VALUES ('web_cc', '0');
INSERT INTO `config`(`k`, `v`) VALUES ('version', '2005');

INSERT INTO `config`(`k`, `v`) VALUES ('is_reg', '1');
INSERT INTO `config`(`k`) VALUES ('gg1','公告1');
INSERT INTO `config`(`k`) VALUES ('gg2','公告2');
INSERT INTO `config`(`k`) VALUES ('gg3','公告3');
